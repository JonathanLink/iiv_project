...
public class DetectionSolver extends Parent{
	...
	public DetectionSolver(PApplet parent, PlateController plateController, PGraphics resultImage, float scale) {
		super(parent);
	...
	public List<PVector> hough(PImage edgeImg) {
		...
		//System.out.println(bestCandidates.size() + " line(s) remind after the local maxima selection.");
